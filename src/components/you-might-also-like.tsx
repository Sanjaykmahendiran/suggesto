    ...
    return (
        <div className="w-full mb-16 mt-6">
            <div className="flex justify-between items-center mb-4">
                ...
                <a href="/add-movie?keyword=yoummightalsolike" className="text-sm bg-gradient-to-r from-[#b56bbc] to-[#7a71c4] bg-clip-text text-transparent">
                    See All
                </a>
            </div>
            ...
            <div className="flex gap-4 overflow-x-auto overflow-y-hidden no-scrollbar pb-2">
                {(loading ? placeholders : movies).map((movie, index) => (
                    <motion.div
                        ...
                        onClick={() =>
                            !loading && movie && router.push(`/movie-detail-page?movie_id=${movie.movie_id}`)
                        }
                    >
                        {loading ? (
                            ...
                            <>
                                ...
                                <div className="absolute top-2 right-2 bg-gradient-to-r from-[#b56bbc] to-[#7a71c4] text-white text-xs px-1.5 py-0.5 rounded-full flex items-center gap-1">
