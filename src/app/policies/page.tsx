...
export default function PoliciesPage() {
  ...
  const renderPolicyContent = () => {
    ...
    return (
      <div className="space-y-6">
        <h2 className="text-xl font-bold capitalize">{activePolicy.replace("policy", " Policy")}</h2>
        <p className="text-sm text-gray-300">Last updated: May 14, 2025</p>
        <div
          className="policy-content font-medium leading-relaxed space-y-4"
  ...
  return (
    <div className="flex flex-col h-screen text-white ">
      {/* Sticky Header */}
      <header className="sticky top-0 z-20 bg-[#121214] px-4 pb-2 pt-8">
