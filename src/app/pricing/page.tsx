...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col items-center">
      ...
      {/* Standard Plan */}
      <div className="mx-4 mb-8 bg-[#2b2b2b] rounded-xl overflow-hidden w-full max-w-[350px] space-y-8 py-8">
        <div className="relative">
          ...
          <div className="pt-8 px-4 text-center">
            ...
            <Button className="w-full text-white bg-[#b56bbc] hover:bg-[#b56bbc] mt-4 mb-6">Select Plan</Button>

            <div className="grid grid-cols-2 gap-4 pb-6">
              <div className="flex items-start space-x-2 justify-center">
                <div className="bg-[#b56bbc] p-1 rounded mt-0.5">
                  <Check size={14} />
                </div>
