...
const SkeletonSuggestion = () => (
  <div className="bg-[#2b2b2b] rounded-lg w-full">
    <div className="flex p-3">
      <Skeleton className="w-20 h-28 rounded-lg bg-gray-600/50" />
      <div className="ml-3 flex-1">
        <div className="flex items-center gap-2 mb-1">
          <Skeleton className="w-5 h-5 rounded-full bg-gray-600/50" />
          <Skeleton className="h-3 w-24 bg-gray-600/50" />
        </div>
        <Skeleton className="h-4 w-32 mb-2 bg-gray-600/50" />
        <Skeleton className="h-16 w-full bg-gray-600/50 rounded-lg mb-2" />
        <div className="flex items-center gap-2">
          <Skeleton className="h-8 w-24 rounded-full bg-gray-600/50" />
          <Skeleton className="h-8 w-24 rounded-full bg-gray-600/50" />
          <Skeleton className="h-8 w-8 rounded-full bg-gray-600/50 ml-auto" />
        </div>
      </div>
    </div>
  </div>
