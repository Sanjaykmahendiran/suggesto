...
export default function Leaderboard() {
            ...
            <div className="h-screen text-white relative">
                ...
                <div className="flex items-center justify-between p-4">
                    <div className="flex items-center gap-2">
                        <div className="mr-4 p-2 rounded-full bg-gray-300 animate-pulse w-10 h-10"></div>
    ...
    return (
                            ...
                            {isViewingFriend && (
                                <div className="fixed bottom-18 left-0 w-full  z-50">
                                    <div className="flex justify-center px-4 py-3">
                                        <div className="flex items-center gap-2 px-6 py-2 rounded-full border border-white/20 text-white bg-[#181826] text-sm">
                                            <button
                                                onClick={toggleLike}
                                    ...
                                    {(isViewingFriend && top10Movies.length < 3 ? top10Movies : otherMovies).map((movieEntry) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`flex items-center gap-4 bg-white/5 p-3 rounded-lg ${!isViewingFriend ? 'cursor-pointer hover:bg-white/10 transition-colors' : ''} ${movieEntry.isMockData ? 'opacity-60' : ''}`}
                                                onClick={() => !isViewingFriend && handleRankingClick(movieEntry.order_no)}
                                            >
                    ...
                    {!isViewingFriend && showRankingModal && (
                        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                            <motion.div
                                ...
                                className="bg-gray-900 rounded-2xl w-full max-w-md max-h-[90vh] overflow-hidden"
                            >
                                {/* Modal Header */}
                                ...
                                <div className="p-4 border-b border-gray-700">
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-3 bg-gray-800 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#6c5ce7]"
                                        />
                                    </div>
                                </div>
                                        ...
                                        {filteredMovies.map((movie) => (
                                            <div
                                                ...
                                                className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors ${selectedMovieForRanking === movie.movie_id
                                                    ? 'bg-[#6c5ce7]/20 border border-[#6c5ce7]'
                                            ...
                                            >
                                                ...
                                                {selectedMovieForRanking === movie.movie_id && (
                                                    <div className="w-6 h-6 bg-[#6c5ce7] rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <BottomNavigation currentPath="/movie-top-wall" />
                </div>
            // </PageTransitionWrapper>
