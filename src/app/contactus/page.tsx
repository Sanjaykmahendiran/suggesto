  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data?.response) {
        ...
        toast.success(data.response || "Message sent successfully.")
      } else {
        ...
        {submitted ? (
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <p className="text-gray-400 mb-6">Your message has been sent successfully. We'll get back to you soon.</p>
                            <Button 
                variant="default" onClick={() => setSubmitted(false)}>Send Another Message</Button>
          </div>
        ) : (
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              variant="gradient"
              type="submit" 
              className="w-full py-6 text-white font-semibold mt-8" disabled={isSubmitting}>
