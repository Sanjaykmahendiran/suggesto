                ...
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">
                            Explore what your Favorites ({totalCount || movies.length} movies)
                        </p>
                    </div>
                </div>
                <Link href="/profile">
                    ...
                    <div className="flex items-center justify-center min-h-[40vh] col-span-2">
                        <NotFound
                            ...
                            description={searchTerm
                                ...
                                : "It seems you haven't Favorites any movies yet. Start exploring our collection!"
                            }
                        />
                    </div>
                ) : (
                    filteredMovies.map((movie, index) => (
                        <Link href={`/movie-detail-page?movie_id=${movie.movie_id}`} key={`${movie.watch_id}-${index}`}>
                            <motion.div
